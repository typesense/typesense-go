...
func NewDeleteDocumentsRequest(server string, collectionName string, params *DeleteDocumentsParams) (*http.Request, error) {
	...
	if params.DeleteDocumentsParameters != nil {
		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "deleteDocumentsParameters", runtime.ParamLocationQuery, *params.DeleteDocumentsParameters); err != nil {
			return nil, err
...
func NewExportDocumentsRequest(server string, collectionName string, params *ExportDocumentsParams) (*http.Request, error) {
	...
	if params.ExportDocumentsParameters != nil {
		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "exportDocumentsParameters", runtime.ParamLocationQuery, *params.ExportDocumentsParameters); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
...
func NewImportDocumentsRequestWithBody(server string, collectionName string, params *ImportDocumentsParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params.ImportDocumentsParameters != nil {
		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "importDocumentsParameters", runtime.ParamLocationQuery, *params.ImportDocumentsParameters); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
...
func NewSearchCollectionRequest(server string, collectionName string, params *SearchCollectionParams) (*http.Request, error) {
	...
	if queryFrag, err := runtime.StyleParamWithLocation("form", true, "searchParameters", runtime.ParamLocationQuery, params.SearchParameters); err != nil {
		return nil, err
	} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
		return nil, err
	} else {
