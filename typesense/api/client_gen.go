...
func NewGetCollectionsRequest(server string, params *GetCollectionsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.GetCollectionsParameters != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "getCollectionsParameters", runtime.ParamLocationQuery, *params.GetCollectionsParameters); err != nil {
				return nil, err
