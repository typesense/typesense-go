...
type GetCollectionsParams struct {
	GetCollectionsParameters *struct {
		// ExcludeFields Comma-separated list of fields from the collection to exclude from the response
		ExcludeFields *string `json:"exclude_fields,omitempty"`

		// Limit Number of collections to fetch. Default: returns all collections.
		Limit *int `json:"limit,omitempty"`

		// Offset Identifies the starting point to return collections when paginating.
		Offset *int `json:"offset,omitempty"`
	} `form:"getCollectionsParameters,omitempty" json:"getCollectionsParameters,omitempty"`
}
